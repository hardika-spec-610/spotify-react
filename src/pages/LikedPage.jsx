...
import BackArrowHeader from "../Component/BackArrowHeader";
...
const LikedPage = () => {
  ...
  useEffect(() => {
    ...
    dispatch(addSongToList(favoriteSongs));
            ...
            <Container fluid>
              <Row className=" align-items-end">
                <Col xs={6} sm={6} md={2} lg={3}>
                  <img src={liked} alt="liked" className="w-100" />
                </Col>
